...
export default [
    ...
    },
    {
        rules: {
            ...
            /**
             * These extensions only make sense inside virmator itself: `.lint.` for its ESLint
             * rules and `.vite.` for its Vite plugins, plus the `.config.base.` / `.config.share.`
             * split that its shipped tool configs use.
             */
