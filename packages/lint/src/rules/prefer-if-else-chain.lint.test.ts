    ...
    it('passes valid cases and catches invalid cases', () => {
        ruleTester.run('prefer-if-else-chain', rule, {
            ...
            invalid: [
                ...
                {
                    name: 'comments between ifs are placed above else-if',
                    code: [
                        'function f(x) {',
                        '    if (x) {',
                        '        return 1;',
                ...
                {
                    name: 'line comment between ifs is placed above else-if',
                    code: [
                        'function f(x) {',
                        '    if (x) {',
                        '        return 1;',
                ...
                {
                    name: 'eslint-disable-next-line between ifs is placed above else-if',
                    code: [
                        'function f(x) {',
                        '    if (x) {',
                        '        return 1;',
